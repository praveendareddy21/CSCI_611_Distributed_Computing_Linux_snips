all:unnamed_pipe simple_fork_example dup_file_read_write dup2_ls_to_file_output mkfifo_example_creat_file mkfifo_example_read_file
...
mkfifo_example_read_file: mkfifo_example_read_file.cpp
	g++ -o mkfifo_example_read_file mkfifo_example_read_file.cpp -lpthread -lrt

clean:
	rm -f unnamed_pipe simple_fork_example dup_file_read_write dup2_ls_to_file_output mkfifo_example_creat_file mkfifo_example_read_file
